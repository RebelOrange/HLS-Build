...
void nlms_module_3tap(axis_stream main_in,
		axis_stream aux_in,
		axis_stream output,
...
#pragma HLS PIPELINE style=flp
	...
	lms.update_weights_normalized(  main_tmp.data.real() - y.real(), main_tmp.data.imag() - y.imag());
...
void nlms_module_1tap(axis_stream main_in,
		axis_stream aux_in,
		axis_stream output,
		ap_ufixed<32,0,AP_TRN,AP_SAT> mu){
#pragma HLS INTERFACE mode=axis port=main_in
